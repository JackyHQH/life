...
public class MenuPermissionFilter implements HelperFilter {
    ...
    CacheWrapper.NoExceptionGuavaCache<String, Integer> MENU_PERMISSION_CACHE =
    ...
    public boolean run(RequestContext context) {
        ...
        int count = MENU_PERMISSION_CACHE.get(menuId+"|"+permissionCode,()-> permissionPlusMapper.countMenuPermission(menuId, finalPermissionCode));
        if (count == 0) {
